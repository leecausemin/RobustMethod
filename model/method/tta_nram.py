...
if __name__ == "__main__":
    ...
    print("\nUsage:")
    print("  from model.method.tta_nram import UnifiedTTANRAM, TTANRAMConfig, inference_with_tta")
    print("\nKey features:")
    print("  ✅ No training needed - uses pre-trained classifier")
    print("  ✅ Test-time adaptation in 5-10 steps")
    print("  ✅ Class-agnostic noise removal")
